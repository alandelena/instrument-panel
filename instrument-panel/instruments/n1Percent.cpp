...
n1Percent::n1Percent(int xPos, int yPos, int size, const char* parentName) : instrument(xPos, yPos, size)
{
    if (parentName) {
...
void n1Percent::resize()
{
    ...
    ALLEGRO_BITMAP* orig = loadBitmap("n1-percent.png");
    addBitmap(orig);
